...
function count_rabbits() {
    ...
    d1.insertAdjacentHTML('afterbegin', ` <input id="input100" class="input100" type="text" name="Surname" placeholder="Фамилия">`);
    ...
    d4.insertAdjacentHTML('afterbegin', `<select class="input100" name="WorkingMode"><option  value="Office" selected="selected">Офис</option><option value="Remoute">Удаленка</option> <option value="Changle">Дежурство</option>`);
